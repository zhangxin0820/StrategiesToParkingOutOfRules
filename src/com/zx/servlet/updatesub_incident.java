...
/**
 * Servlet implementation class updatesub_incident
 */
@WebServlet("/updatesub_incident")
public class updatesub_incident extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updatesub_incident() {
        super();
