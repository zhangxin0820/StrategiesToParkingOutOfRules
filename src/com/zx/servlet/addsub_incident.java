...
/**
 * Servlet implementation class addsub_incident
 */
@WebServlet("/addsub_incident")
public class addsub_incident extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public addsub_incident() {
		super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		response.sendRedirect("showSub_incident.jsp");
	}
