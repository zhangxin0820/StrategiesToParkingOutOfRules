...
/**
 * Servlet implementation class updateparking_person
 */
@WebServlet("/updateparking_person")
public class updateparking_person extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public updateparking_person() {
        super();
